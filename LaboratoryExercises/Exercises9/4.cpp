...
public:
    ...
    void izvestajVoEvra()
    {
        ...
        cout<<"Korisnikot so smetka: "<<id<<" ima momentalno saldo od "<<s/Transakcija::evro<<" EUR"<<endl;
    }
    void izvestajVoDolari()
    {
        ...
        cout<<"Korisnikot so smetka: "<<id<<" ima momentalno saldo od "<<s/Transakcija::dolar<<" USD"<<endl;
    }
