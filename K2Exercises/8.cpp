...
private:
    ...
    float cenabilet;
public:
    Koncert(const char *naziv="",const char *lokacija="",float cenabilet=0.0)
    {
...
private:
    ...
    bool dnevna;
public:
    ElektronskiKoncert(const char *naziv="",const char *lokacija="",float cenabilet=0.0,const char *dj="",double vreme=0.0,bool dnevna=true):Koncert(naziv,lokacija,cenabilet)
    {
